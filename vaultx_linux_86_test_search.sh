...
./vaultx_linux_x86 -t 32 -i 1 -m 2048 -k 31 -g data-32GB.tmp -f data-32GB.bin
...
for diff in 3 4; do
    ...
    # Run vaultx and collect its metrics
    ./vaultx_linux_x86 -k 31 -f data-32GB.bin -s 1000 -q $diff -d true 2>&1| \
...
./vaultx_linux_x86 -t 32 -i 1 -m 2048 -k 32 -g data-64GB.tmp -f data-64GB.bin
...
for diff in 3 4; do
    ...
    # Run vaultx and collect its metrics
    ./vaultx_linux_x86 -k 32 -f data-64GB.bin -s 1000 -q $diff -d true 2>&1| \
